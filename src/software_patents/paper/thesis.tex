...
\begin{table}[tb]\caption{Confusion Matrix of \cite{bessen2007empirical}}\label{tab:confusion_algo_original}\centering\ra{1.3}
    \input{../../../bld/tables/tab-cf-replication-bh-with-crawled-text}
\end{table}
...
\begin{figure}[tb]
	\centering
	\includegraphics[width=0.7\textwidth]{../../../bld/figures/fig-patents-distribution-vs}
...
\begin{figure}[tb]
	\centering
	\includegraphics[width=0.7\textwidth]{../../../bld/figures/fig-patents-distribution-vs-shares}
...
\begin{figure}[!ht]
	\centering
	\includegraphics[width=0.9\textwidth]{../../../bld/figures/fig-patents-distribution}
